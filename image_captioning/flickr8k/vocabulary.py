...
class Flickr8kVocabularyFactory:
    ...
    def build_vocabulary_from_annotation(
        ...
        if not os.path.exists(root):
            raise IOError(f'Path {root} is not valid')
        ...
        word2idx = {
            ...
            stop_token: 1,
            unknown_token: 2,
            **{word: idx for idx, (word, occurrences) in enumerate(counter.most_common(), 3) if
               occurrences > vocab_threshold}
        }
